...
if debug:
    ...
    def home():
        if flask.request.method == "POST":
            user_address = flask.request.form["address"]
            if user_address != "":
                return flask.redirect(flask.url_for("wallet", address=user_address))
            else:
    ...
    @app.route("/faq")
    def faq():
        return flask.render_template("app.html", display_page="faq.html")
